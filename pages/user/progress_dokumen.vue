<template>
    <section class="h-screen flex flex-col justify-start items-center bg-white mt-10 md:mt-32">
        <Header2></Header2>
        ...
        <div class="flex flex-col justify-center items-center gap-10">
            ...
            <div class="flex flex-col w-[500px]">
                ...
                <input id="judul_proposal_2" type="text" name="judul_proposal" placeholder="Input Catatan BPP"
                    class="rounded-lg bg-gray-50 h-20 border-2 border-gray-300" v-model="documentData" />
            </div>
