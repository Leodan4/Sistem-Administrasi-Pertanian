        ...
        >
          ...
          <tbody class="divide-y">
            ...
            >
              ...
              <td class="px-3 py-4">{{ item.namaPenerima }}</td>
              <td class="px-3 py-4">{{ item.noTelpPenerima }}</td>
              <td class="px-3 py-4">{{ item.tanggal }}</td>
              <td class="px-3 py-4">
                <div
                  :class="{
...
const tableData = ref([
  {
    nama: "John Doe",
    noTelp: "0889790990",
    asalInstansi: "Company ABC",
    namaPenerima: "Jane Doe",
    noTelpPenerima: "0812345678",
    tanggal: "2024-02-20",
    status: "Selesai",
    foto: "/assets/photo1.jpg",
  },
  {
    nama: "Alice Smith",
    noTelp: "0876543210",
    asalInstansi: "Organization XYZ",
    namaPenerima: "Bob Johnson",
    noTelpPenerima: "0823456789",
    tanggal: "2024-02-22",
    status: "Proses",
    foto: "/assets/photo2.jpg",
  },
  {
    nama: "Eva Williams",
    noTelp: "0812345678",
    asalInstansi: "Institution LMN",
    namaPenerima: "David Lee",
    noTelpPenerima: "0888765432",
    tanggal: "2024-02-25",
    status: "Gagal",
    foto: "/assets/photo3.jpg",
  },
]);
</script>
