          ...
          <tbody class="border-2 border-gray-300">
            ...
            <tr>
              ...
              <td class="py-2 px-4 text-center">
                <span class="bg-green-100 text-green-700 font-semibold px-4 py-1 rounded">Telah Disesuaikan</span>
              </td>
              <td class="py-2 px-4 text-center ">
                <button class="bg-[#0E9F6E] hover:bg-green-700 text-white py-1 px-4 rounded">Tinjau Ulang</button>
              </td>
            </tr>
