...
<template>
    <MainLayoutDInas>
      <section class="min-h-screen flex flex-col py-8 md:py-16 lg:py-24 items-center bg-white">
            ...
            <div class="flex flex-col gap-4">
              <div class="flex flex-col w-full">
                ...
                <input
                  ...
                  type="text"
                  name="no_doc"
                  placeholder="Input No Dokumen"
                  class="rounded-lg bg-gray-50 border-2 border-gray-300 w-full"
                  v-model="formData.no_doc"
                  readonly
                />
              </div>
              ...
              <div class="flex flex-col w-full">
                ...
                <div
                  id="jenis_bantuan"
                  class="rounded-lg bg-gray-50 border-2 border-gray-300 h-11 flex items-center px-3"
                >
            ...
            <div class="flex flex-col gap-4">
              <div class="flex flex-col w-full">
                ...
                <input
                  ...
                  class="rounded-lg bg-gray-50 border-2 border-gray-300 w-full"
                  v-model="formData.judul_dokumen"
                  readonly
                />
              </div>
