            ...
            <div class="flex flex-row justify-center items-center gap-10 ">
                <div class="">
                    ...
                    <div class="flex flex-col w-full py-4">
                        ...
                        <div id="surat_tugas" type="text" name="surat_tugas" class="rounded-lg bg-gray-50  border-2 h-11 border-gray-300"  >
                ...
                <div class="">
                    ...
                    <div class="flex flex-col w-[500px] py-4">
                        ...
                        <div id="sumber_dana" name="sumber_dana" class="flex items-center px-3 rounded-lg h-11 bg-gray-50 border-2 border-gray-300" >
                    ...
                    <div class="flex flex-col w-[500px] py-4">
                        ...
                        <div id="surat_tugas" type="text" name="surat_tugas" class="flex items-center px-3 rounded-lg h-11 bg-gray-50 border-2 border-gray-300"  >
