        ...
        <table class="min-w-full bg-white-800 rounded-xl overflow-hidden">
          ...
          <tbody class="border-2 border-gray-300">
            ...
            <tr>
              ...
              <td class="py-2 px-4 text-center ">
                <button class="bg-[#0E9F6E] hover:bg-green-700 text-white py-1 px-4 mx-4 rounded">Detail</button>
                <button class="border-[#0E9F6E] text-[#0E9F6E]  py-1 px-4 rounded">Realisasi</button>
              </td>
            </tr>
