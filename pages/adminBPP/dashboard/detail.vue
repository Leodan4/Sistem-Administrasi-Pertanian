...
// const fetchDocumentDetails = async () => {
//   try {
//     await dashboardStore.getDocumentById(route.query.id); // Assuming you have a method to fetch a single document by ID
//     const document = dashboardStore.document;
//     formData.value.type_doc = document.type_doc;
//     formData.value.note = document.note;
//   } catch (error) {
//     console.error('Failed to fetch document details:', error);
//   }
// };
