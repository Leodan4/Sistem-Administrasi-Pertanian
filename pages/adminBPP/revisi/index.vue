...
import ModalComponent from "~/pages/adminBPP/revisi/detail.vue";
...
const documents = computed(() => {
  const filteredDocs = dashboardStore.data ? dashboardStore.data.filter(doc => doc.status_baru_proposal === 'revisi') : [];
